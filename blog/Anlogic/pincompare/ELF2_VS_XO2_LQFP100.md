---
title: "ELF2 VS XO2 LQFP100 Pinout Table"
...
**芯片对比**: Anlogic ELF2 lqfp100 VS Lattice xo2-2000  lqfp100


## IO BANK 0, 3

| Anlogic ELF2 lqfp100 | | | Lattice xo2-2000  lqfp100 | | | |
| 引脚编号 | IO BANK | 引脚说明 | 引脚编号 | IO BANK | 引脚说明 | 差异备注 |
|----------|---------|----------|----------|---------|----------|----------|
| 1 | 0 | IO_BE1N_0,D1 | 1 | 3 | PL2C | 差分对PN端不同，XO2不支持并行加载模式 |
| 2 | 0 | IO_BE1P_0,D0 | 2 | 3 | PL2D | 差分对PN端不同，XO2不支持并行加载模式 |
| 3 | 0 | IO_BE2N_GCLKIOB_1_0 | 3 | 3 | PL3A | 差分对PN端不同 |
| 4 | 0 | IO_BE2P_GCLKIOB_0_0 | 4 | 3 | PL3B | 差分对PN端不同 |
| 5 | 0 | VCCIO0 | 5 | 3 | VCCIO3 | - |
| 6 | 0 | GND | 6 | - | GND | - |
| 7 | 0 | IO_BE3N_0,D3 | 7 | 3 | PL3C | 差分对PN端不同，XO2不支持并行加载模式 |
| 8 | 0 | IO_BE3P_0,D2 | 8 | 3 | PL3D | 差分对PN端不同，XO2不支持并行加载模式 |
| 9 | 0 | IO_BE4P_0 | 9 | 3 | PL4A | - |
| 10 | 0 | IO_BE4N_0 | 10 | 3 | PL4B | - |
| 11 | 0 | VCCIO0 | 11 | 3 | VCCIO3 | - |
| 12 | 0 | IO_BE5P_GCLKIOB_2_0 | 12 | 3 | PL5A | - |
| 13 | 0 | IO_BE5N_GCLKIOB_3_0 | 13 | 3 | PL5B | - |
| 14 | 0 | IO_BE6P_0,DPCLKIO_4 | 14 | 3 | PL5C | - |
| 15 | 0 | IO_BE6N_0 | 15 | 3 | PL5D | - |
| 16 | 0 | IO_BE7P_0 | 16 | 3 | PL8A | - |
| 17 | 0 | IO_BE7N_0 | 17 | 3 | PL8B | - |
| 18 | 0 | IO_BE8P_0 | 18 | 3 | PL8C | - |
| 19 | 0 | IO_BE8N_0 | 19 | 3 | PL8D | - |
| 20 | 0 | IO_BE9P_GCLKIOB_4,D4 | 20 | 3 | PL9A | XO2不支持并行加载模式 |
| 21 | 0 | IO_BE9N_GCLKIOB_5,D5 | 21 | 3 | PL9B | XO2不支持并行加载模式 |
| 22 | 0 | GND | 22 | - | GND | - |
| 23 | 0 | VCCIO0 | 23 | 3 | VCCIO3 | - |
| 24 | 0 | IO_BE10P_0,D6 | 24 | 3 | PL10C | XO2不支持并行加载模式 |
| 25 | 0 | IO_BE10N_0,D7 | 25 | 3 | PL10D | XO2不支持并行加载模式 |
...
| 引脚编号 | IO BANK | 引脚说明 | 引脚编号 | IO BANK | 引脚说明 | 差异备注 |
|----------|---------|----------|----------|---------|----------|----------|
| 26 | 1 | VCCIO1 | 26 | 2 | VCCIO2 | - |
| 27 | 1 | IO_R1P_1 | 27 | 2 | PB4C | ELF2为真差分，XO2为伪差分，ELF2不支持外接FLASH的主动串行模式 |
| 28 | 1 | IO_R1N_1 | 28 | 2 | PB4D | ELF2为真差分，XO2为伪差分 |
| 29 | 1 | IO_R2P_1 | 29 | 2 | PB6A | ELF2为真差分，XO2为伪差分 |
| 30 | 1 | IO_R2N_1 | 30 | 2 | PB6B | ELF2为真差分，XO2为伪差分 |
| 31 | 1 | IO_R3P_1 | 31 | 2 | PB6C | ELF2为真差分，XO2为伪差分，ELF2不支持外接FLASH的主动串行；ELF2的从动串行时钟引脚与XO2不兼容，且操作模式不兼容 |
| 32 | 1 | IO_R3N_1 | 32 | 2 | PB6D | ELF2为真差分，XO2为伪差分，ELF2不支持外接FLASH的主动串行；ELF2的从动串行引脚与XO2不兼容，且操作模式不兼容 |
| 33 | 1 | GND | 33 | - | GND | - |
| 34 | 1 | IO_R4N_GCLKIOR_1_1,LVDSTX_1N | 34 | 2 | PB9A | 差分对PN端不同，ELF2为真差分，XO2为伪差分 |
| 35 | 1 | IO_R4P_GCLKIOR_0_1,LVDSTX_1P | 35 | 2 | PB9B | 差分对PN端不同，ELF2为真差分，XO2为伪差分 |
| 36 | 1 | IO_R5P_1 | 36 | 2 | PB11C | ELF2为真差分，XO2为伪差分 |
| 37 | 1 | IO_R5N_1,DPCLKIO_5 | 37 | 2 | PB11D | ELF2为真差分，XO2为伪差分 |
| 38 | 1 | IO_R6N_GCLKIOR_3_1, LVDSTX_1N | 38 | 2 | PB11A | 差分对PN端不同，ELF2为真差分，XO2为伪差分 |
| 39 | 1 | IO_R6P_GCLKIOR_2_1, LVDSTX_1P | 39 | 2 | PB11B | 差分对PN端不同，ELF2为真差分，XO2为伪差分 |
| 40 | 1 | IO_R7N_1,LVDSRX_1N | 40 | 2 | PB15A | 差分对PN端不同，ELF2为真差分，XO2为伪差分 |
| 41 | 1 | IO_R7P_1,LVDSRX_1P | 41 | 2 | PB15B | 差分对PN端不同，ELF2为真差分，XO2为伪差分 |
| 42 | 1 | IO_R8P_1 | 42 | 2 | PB18A | ELF2为真差分，XO2为伪差分 |
| 43 | 1 | IO_R8N_1 | 43 | 2 | PB18B | ELF2为真差分，XO2为伪差分 |
| 44 | 1 | GND | 44 | - | GND | - |
| 45 | 1 | IO_R9P_1,SCLK | 45 | 2 | PB18C | ELF2为真差分，XO2为伪差分，ELF2主并，从并，从串时钟，与XO2不兼容 |
| 46 | 1 | VCCIO1 | 46 | 2 | VCCIO2 | - |
| 47 | 1 | IO_R9N_1 | 47 | 2 | PB18D | ELF2为真差分，XO2为伪差分 |
| 48 | 1 | IO_R10N_1 | 48 | 2 | PB20C | 差分对PN端不同，ELF2为真差分，XO2从串配置片选，与ELF2不兼容 |
| 49 | 1 | IO_R10P_1 | 49 | 2 | PB20D | 差分对PN端不同，ELF2为真差分，XO2主串，从串模式SI，与ELF2不兼容 |
...
| 引脚编号 | IO BANK | 引脚说明 | 引脚编号 | IO BANK | 引脚说明 | 差异备注 |
|----------|---------|----------|----------|---------|----------|----------|
| 51 | 2 | IO_TE1N_2,GPIO4 | 51 | 1 | PR10D | - |
| 52 | 2 | IO_TE1P_2,GPIO3 | 52 | 1 | PR10C | - |
| 53 | 2 | IO_TE2N_2 | 53 | 1 | PR9D | - |
| 54 | 2 | IO_TE2P_2 | 54 | 1 | PR9C | - |
| 55 | 2 | VCCIO2 | 55 | 1 | VCCIO1 | - |
| 56 | 2 | GND | 56 | - | GND | - |
| 57 | 2 | IO_TE3N_2,GPIO13 | 57 | 1 | PR9B | - |
| 58 | 2 | IO_TE3P_2,GPIO12 | 58 | 1 | PR9A | - |
| 59 | 2 | IO_TE4N_2,GPIO11 | 59 | 1 | PR8D | - |
| 60 | 2 | IO_TE4P_2,GPIO10 | 60 | 1 | PR8C | - |
| 61 | 2 | IO_T_2,GPIO8,USRCLK,ADC1_CH2 | 61 | 1 | PR8A | - |
| 62 | 2 | IO_TE5N_GCLKIOT_3_2 | 62 | 1 | PR5D | - |
| 63 | 2 | IO_TE5P_GCLKIOT_2_2 | 63 | 1 | PR5C | - |
| 64 | 2 | IO_TE6N_GCLKIOT_1_2 | 64 | 1 | PR5B | - |
| 65 | 2 | IO_TE6P_GCLKIOT_0_2 | 65 | 1 | PR5A | - |
| 66 | 2 | IO_T_2 | 66 | 1 | PR4D | ELF2不支持差分 |
| 67 | 2 | IO_T_2,GPIO7_ADC1_CH1 | 67 | 1 | PR4C | ELF2不支持差分 |
| 68 | 2 | IO_T_2,GPIO6,DPCLKIO_8,ADC1_CH0 | 68 | 1 | PR4B | ELF2不支持差分 |
| 69 | 2 | IO_T_2,GPIO5,ADC0_REF | 69 | 1 | PR4A | ELF2不支持差分；如使用ADC0，则必须接该电压，输入范围2-3.3V，且不大于ADC_VDDA |
| 70 | 2 | IO_TE7P_2,GPIO0,ADC1_CH4 | 70 | 1 | PR3B | 差分对PN端不同 |
| 71 | 2 | IO_TE7N_2,GPIO1,ADC1_REF | 71 | 1 | PR3A | 差分对PN端不同；如使用ADC1，则必须接该电压，输入范围2-3.3V，且不大于ADC_VDDA |
| 72 | 2 | GND | 72 | - | GND | - |
| 73 | 2 | VCCIO2,ADC_VDDA,ADC_VDDD | 73 | 1 | VCCIO1 | ELF2为ADC_VDDA、ADC_VDDD、VCCIO共用引脚 |
| 74 | 2 | IO_T_2 | 74 | 1 | PR2B | ELF2不支持差分 |
...
| 引脚编号 | IO BANK | 引脚说明 | 引脚编号 | IO BANK | 引脚说明 | 差异备注 |
|----------|---------|----------|----------|---------|----------|----------|
| 76 | 3 | IO_L_3 , DONE | 76 | 0 | PT17D | - |
| 77 | 3 | IO_L_3, INITN | 77 | 0 | PT17C | ELF2必须上拉 |
| 78 | 3 | IO_L_3, ADC0_CH0 | 78 | 0 | PT16C | - |
| 79 | 3 | GND | 79 | - | GND | - |
| 80 | 3 | VCCIO3 | 80 | 0 | VCCIO0 | - |
| 81 | 3 | IO_L_3,PROGRAMN | 81 | 0 | PT15D | ELF2必须上拉 |
| 82 | 3 | IO_L_3,JTAGEN | 82 | 0 | PT15C | - |
| 83 | 3 | IO_L1N_3,DPCLKIO_1 | 83 | 0 | PT15B | - |
| 84 | 3 | IO_L1P_3 | 84 | 0 | PT15A | - |
| 85 | 3 | IO_L2N_GCLKIOL_1_3, ADC0_CH1,LVDSRX_0N | 85 | 0 | PT12D | ELF2为真差分，XO2为伪差分；XO2可作为I2C SDA，ELF2无I2C。 |
| 86 | 3 | IO_L2P_GCLKIOL_0_3,  ADC0_CH2 ,LVDSRX_0P | 86 | 0 | PT12C | ELF2为真差分，XO2为伪差分；XO2可作为I2C SCL，ELF2无I2C。 |
| 87 | 3 | IO_L3N_GCLKIOL_3_3, ADC0_CH3,LVDSTX_0N | 87 | 0 | PT12B | - |
| 88 | 3 | IO_L3P_GCLKIOL_2_3, ADC0_CH4,LVDSTX_0P | 88 | 0 | PT12A | - |
| 89 | 3 | IO_L_3 | 89 | - | NC | - |
| 90 | 3 | IO_L_3,TMS | 90 | 0 | PT11D | - |
| 91 | 3 | IO_L_3,TCK | 91 | 0 | PT11C | - |
| 92 | 3 | GND | 92 | - | GND | - |
| 93 | 3 | VCCIO3 | 93 | 0 | VCCIO0 | - |
| 94 | 3 | IO_L_3,TDI | 94 | 0 | PT10D | - |
| 95 | 3 | IO_L_3,TDO | 95 | 0 | PT10C | - |
| 96 | 3 | IO_L4P_3 | 96 | 0 | PT10B | 差分对PN端不同 |
| 97 | 3 | IO_L4N_3 | 97 | 0 | PT10A | 差分对PN端不同 |
| 98 | 3 | IO_L5N_3 | 98 | 0 | PT9B | - |
| 99 | 3 | IO_L5P_3 | 99 | 0 | PT9A | - |
...
| 引脚编号 | IO BANK | 引脚说明 | 引脚编号 | IO BANK | 引脚说明 | 差异备注 |
|----------|---------|----------|----------|---------|----------|----------|
| 50 | - | VCCAUX | 50 | - | VCC | VCCAUX必须接2.5V或者3.3V |
| 75 | - | IO_T_2 | 75 | 1 | PR2A | ELF2不支持差分 |
| 100 | - | VCCAUX | 100 | - | VCC | VCCAUX必须接2.5V或者3.3V |
