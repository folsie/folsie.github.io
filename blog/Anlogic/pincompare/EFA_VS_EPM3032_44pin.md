---
title: "EFA VS EPM3032 44pin Pinout Table"
...
**芯片对比**: Anlogic EFA300/650 LQFP44 VS ALTERA EPM3032 TQFP44


## IO BANK 0, IO, TDO

| Anlogic EFA300/650 LQFP44 | | | ALTERA EPM3032 TQFP44 | | | |
...
| 21 | 0 | IO | B | IO | - | - |
| 22 | 0 | IO | B | IO | - | - |
| 32 | 0 | IO,TDO | B | TDO | TDO | - |


## IO BANK 1, 2, INPUT、GCLRn, IO, IO,TDI, TCK, TMS

| Anlogic EFA300/650 LQFP44 | | | ALTERA EPM3032 TQFP44 | | | |
| 引脚编号 | IO BANK | 引脚说明 | 引脚编号 | IO BANK | 引脚说明 | 差异备注 |
|----------|---------|----------|----------|---------|----------|----------|
| 1 | 1 | IO,TDI | A | IO,TDI | TDI | - |
| 7 | 1 | IO,TMS | A | TMS | TMS | - |
| 23 | 1 | IO | B | IO | - | - |
| 25 | 1 | IO | B | IO | - | - |
| 26 | 1 | IO,TCK | B | TCK | TCK | - |
| 27 | 1 | IO,GCLK1 | B | IO | - | - |
| 28 | 1 | IO | B | IO | - | - |
| 31 | 1 | IO | B | IO | - | - |
| 33 | 1 | IO | B | IO | - | - |
| 34 | 1 | IO | B | IO | - | - |
| 35 | 1 | IO | B | IO | - | - |
| 37 | 1 | IO,GCLK7 | - | 1 | 全局时钟专用引脚 | - |
| 38 | 1 | IO | - | 1 | 输出使能 | - |
| 39 | 1 | IO | - | INPUT、GCLRn | 全局清零信号 | - |
| 40 | 1 | IO,GCLK6 | - | 2 | 输出使能、全局时钟专用引脚 | - |
| 42 | 1 | IO | A | IO | - | - |
| 43 | 1 | IO | A | IO | - | - |
| 44 | 1 | IO | A | IO | - | - |


## IO BANK GNDINT, GNDIO
