---
title: "ELFA VS EPM240 LQFP100 Pinout Table"
subtitle: "2026.04.09"
...
**芯片对比**: Anlogic ELFA300/650 LQFP100 VS ALTERA EPM240 TQFP100


## IO BANK 0, 2

| Anlogic ELFA300/650 LQFP100 | | | ALTERA EPM240 TQFP100 | | | |
| 引脚编号 | IO BANK | 引脚说明 | 引脚编号 | IO BANK | 引脚说明 | 差异备注 |
|----------|---------|----------|----------|---------|----------|----------|
| 76 | 0 | IO | 76 | 2 | IO | - |
| 77 | 0 | IO | 77 | 2 | IO | - |
| 78 | 0 | IO | 78 | 2 | IO | - |
| 79 | 0 | VSSIO | 79 | 2 | GNDIO | - |
| 80 | 0 | VCCIO0 | 80 | 2 | VCCIO2 | BANK电压，ELF650和EPM240的BANK划分不同 |
| 81 | 0 | IO | 81 | 2 | IO | - |
| 82 | 0 | IO | 82 | 2 | IO | - |
| 83 | 0 | IO | 83 | 2 | IO | - |
| 84 | 0 | IO | 84 | 2 | IO | - |
| 85 | 0 | IO,GCLK1 | 85 | 2 | IO | ELF为全局时钟输入 |
| 86 | 0 | IO,GCLK0 | 86 | 2 | IO | ELF为全局时钟输入 |
| 87 | 0 | IO | 87 | 2 | IO | - |
| 88 | 0 | IO | 88 | 2 | IO | ELF JTAG配置脚可通过软件设置为GPIO，用JTAGEN脚取回JTAG控制权限，不需要JTAG引脚复用时，该引脚可用作GPIO |
| 89 | 0 | IO,JTAGEN | 89 | 2 | IO | - |
| 90 | 0 | IO | 90 | 2 | IO | - |
| 91 | 0 | IO | 91 | 2 | IO | - |
| 92 | 0 | IO | 92 | 2 | IO | - |
| 93 | 0 | VSSIO | 93 | 2 | GNDIO0 | - |
| 94 | 0 | VCCIO0 | 94 | 2 | VCCIO2 | BANK电压，ELF650和EPM240的BANK划分不同 |
| 95 | 0 | IO | 95 | 2 | IO | - |
| 96 | 0 | IO | 96 | 2 | IO | - |
| 97 | 0 | IO | 97 | 2 | IO | - |
| 98 | 0 | IO | 98 | 2 | IO | - |
...
| 引脚编号 | IO BANK | 引脚说明 | 引脚编号 | IO BANK | 引脚说明 | 差异备注 |
|----------|---------|----------|----------|---------|----------|----------|
| 53 | 1 | IO,LVDSR0N | 53 | 2 | IO | - |
| 54 | 1 | IO,LVDSR0P | 54 | 2 | IO | - |
| 55 | 1 | IO,LVDSR1N | 55 | 2 | IO | - |
| 56 | 1 | IO,LVDSR1P | 56 | 2 | IO | - |
| 57 | 1 | IO,LVDSR2N | 57 | 2 | IO | - |
| 58 | 1 | IO,LVDSR2P | 58 | 2 | IO | - |
| 59 | 1 | VCCIO1 | 59 | 2 | VCCIO2 | BANK电压，ELF650和EPM240的BANK划分不同 |
| 60 | 1 | VSSIO | 60 | 2 | GNDIO | - |
| 61 | 1 | IO | 61 | 2 | IO | - |
| 62 | 1 | IO | 62 | 2 | IO,GCLK2 | EPM240为全局时钟输入 |
| 63 | 1 | VCCRXT | 63 | 2 | VCCINT | - |
| 64 | 1 | IO | 64 | 2 | IO,GCLK3 | EPM240为全局时钟输入 |
| 65 | 1 | GND | 65 | 2 | GNDINT | - |
| 66 | 1 | IO,LVDSR3N | 66 | 2 | IO | - |
| 67 | 1 | IO,LVDSR3P | 67 | 2 | IO | - |
| 68 | 1 | IO,LVDSR4N | 68 | 2 | IO | - |
| 69 | 1 | IO,LVDSR4P | 69 | 2 | IO | - |
| 70 | 1 | IO,LVDSR5N | 70 | 2 | IO | - |
| 71 | 1 | IO,LVDSR5P | 71 | 2 | IO | - |
| 72 | 1 | IO,LVDSR6N | 72 | 2 | IO | - |
| 73 | 1 | IO,LVDSR6P | 73 | 2 | IO | - |
| 74 | 1 | IO,LVDSR7N | 74 | 2 | IO | - |
| 75 | 1 | IO,LVDSR7P | 75 | 2 | IO | - |
...
| 26 | 2 | IO | 26 | 1 | IO | - |
| 27 | 2 | IO | 27 | 1 | IO | - |
| 28 | 2 | IO,SPICSN | 28 | 1 | IO | EPM240不支持MSPI加载方式 |
| 29 | 2 | IO,MISO | 29 | 1 | IO | EPM240不支持MSPI加载方式 |
| 30 | 2 | IO | 30 | 1 | IO | - |
| 31 | 2 | VCCIO2 | 31 | 1 | VCCIO1 | BANK电压，ELF650和EPM240的BANK划分不同 |
| 32 | 2 | VSSIO | 32 | 1 | GNDIO | - |
| 33 | 2 | IO,SCLK | 33 | 1 | IO | EPM240不支持MSPI加载方式 |
| 34 | 2 | IO | 34 | 1 | IO | - |
| 35 | 2 | IO,MOSI | 35 | 1 | IO | EPM240不支持MSPI加载方式 |
| 36 | 2 | IO | 36 | 1 | IO | - |
| 37 | 2 | IO,GCLK5 | 37 | 1 | IO | ELF为全局时钟输入 |
| 38 | 2 | IO | 38 | 1 | IO | - |
| 39 | 2 | IO,GCLK4 | 39 | 1 | IO | ELF为全局时钟输入 |
| 40 | 2 | IO | 40 | 1 | IO | - |
| 41 | 2 | IO | 41 | 1 | IO | - |
| 42 | 2 | IO | 42 | 1 | IO | - |
| 43 | 2 | IO | 43 | 1 | IO,DEV_OE | - |
| 44 | 2 | IO | 44 | 1 | IO,DEV_CLRn | - |
| 45 | 2 | VCCIO2 | 45 | 1 | VCCIO1 | BANK电压，ELF650和EPM240的BANK划分不同 |
| 46 | 2 | VSSIO | 46 | 1 | GNDIO | - |
| 47 | 2 | IO,SCL | 47 | 1 | IO | - |
| 48 | 2 | IO,PROGRAMN | 48 | 1 | IO | ELF该引脚为双功能引脚，必须外部上拉 |
| 49 | 2 | IO,SDA | 49 | 1 | IO | - |
| 50 | 2 | IO,PWRDWN | 50 | 1 | IO | - |
| 51 | 2 | IO,INITN | 51 | 1 | IO | ELF该引脚为双功能引脚，必须外部上拉 |
| 52 | 2 | IO,DONE | 52 | 2 | IO | - |
...
| 7 | 3 | IO | 7 | 1 | IO | - |
| 8 | 3 | IO | 8 | 1 | IO | - |
| 9 | 3 | VCCIO3 | 9 | 1 | VCCIO1 | BANK电压，ELF650和EPM240的BANK划分不同 |
| 10 | 3 | VSSIO | 10 | 1 | GNDIO | - |
| 11 | 3 | GND | 11 | 1 | GNDINT | - |
| 12 | 3 | IO,GCLK7 | 12 | 1 | IO,GCLK0 | - |
| 13 | 3 | VCCEXT | 13 | 1 | VCCINT | - |
| 14 | 3 | IO,GCLK6 | 14 | 1 | IO,GCLK1 | - |
| 15 | 3 | IO | 15 | 1 | IO | - |
| 16 | 3 | IO | 16 | 1 | IO | - |
| 17 | 3 | IO | 17 | 1 | IO | - |
| 18 | 3 | IO | 18 | 1 | IO | - |
...
| 20 | 3 | IO | 20 | 1 | IO | - |
| 21 | 3 | IO | 21 | 1 | IO | - |
| 22 | 3 | IO,TMS | 22 | 1 | TMS | - |
| 23 | 3 | IO,TDI | 23 | 1 | TDI | - |
| 24 | 3 | IO,TCK | 24 | 1 | TCK | - |
| 25 | 3 | IO,TDO | 25 | 1 | TDO | - |
