...
**芯片对比**: PH1A100GSG324 VS XC7A100TCSG324                                                                                                                                                                       2019-10-9


## IO BANK 12, 14

| PH1A100GSG324 | | | XC7A100TCSG324                                                                                                                                                                       2019-10-9 | | | |
...
| A13 | 13 | IO_L9P_13,GPLL1_OUTP | A13 | 15 | IO_L9P_T1_DQS_AD3P_15 | - |
| A14 | 13 | IO_L9N_13,GPLL1_OUTN | A14 | 15 | IO_L9N_T1_DQS_AD3N_15 | - |
...
| D17 | 13 | IO_L16N_13,GPLL0_OUTN | D17 | 15 | IO_L16N_T2_A27_15 | - |
...
| E17 | 13 | IO_L16P_13,GPLL0_OUTP | E17 | 15 | IO_L16P_T2_A28_15 | - |
...
| 引脚编号 | IO BANK | 引脚说明 | 引脚编号 | IO BANK | 引脚说明 | 差异备注 |
|----------|---------|----------|----------|---------|----------|----------|
| A8 | 14 | IO_L2N_14,GCLKIOC2 | A8 | 16 | IO_L12N_T1_MRCC_16 | PH1A100和XC7A100在差分时钟的N端输入，不可输入单端时钟。 |
| A9 | 14 | IO_L4N_14,GCLKIOC0 | A9 | 16 | IO_L14N_T2_SRCC_16 | PH1A100和XC7A100在差分时钟的N端输入，不可输入单端时钟。 |
| B8 | 14 | IO_L2P_14,GCLKIOT2 | B8 | 16 | IO_L12P_T1_MRCC_16 | PH1A100是全局时钟输入引脚， XC7A100是多区域时钟输入引脚。单端和差分均可从P端输入。 |
| B9 | 14 | IO_L1N_14,GCLKIOC3 | B9 | 16 | IO_L11N_T1_SRCC_16 | PH1A100和XC7A100在差分时钟的N端输入，不可输入单端时钟。 |
| C9 | 14 | IO_L1P_14,GCLKIOT3 | C9 | 16 | IO_L11P_T1_SRCC_16 | PH1A100是全局时钟输入引脚， XC7A100是单区域时钟输入引脚。单端和差分均可从P端输入。 |
| D9 | 14 | IO_L0_14 | D9 | 16 | IO_L6N_T0_VREF_16 | - |
| A10 | 14 | IO_L4P_14,GCLKIOT0 | A10 | 16 | IO_L14P_T2_SRCC_16 | PH1A100是全局时钟输入引脚， XC7A100是单区域时钟输入引脚。单端和差分均可从P端输入。 |
| C10 | 14 | IO_L3N_14,GCLKIOC1 | C10 | 16 | IO_L13N_T2_MRCC_16 | PH1A100和XC7A100在差分时钟的N端输入，不可输入单端时钟。 |
| C11 | 14 | IO_L3P_14,GCLKIOT1 | C11 | 16 | IO_L13P_T2_MRCC_16 | PH1A100是全局时钟输入引脚， XC7A100是多区域时钟输入引脚。单端和差分均可从P端输入。 |
| D10 | 14 | IO_L5_14 | D10 | 16 | IO_L19N_T3_VREF_16 | - |
...
| U2 | 32 | IO_R9P_32,GPLL1_OUTP | U2 | 34 | IO_L9P_T1_DQS_34 | - |
...
| V2 | 32 | IO_R9N_32,GPLL1_OUTN | V2 | 34 | IO_L9N_T1_DQS_34 | - |
...
| 引脚编号 | IO BANK | 引脚说明 | 引脚编号 | IO BANK | 引脚说明 | 差异备注 |
|----------|---------|----------|----------|---------|----------|----------|
| A1 | 33 | IO_R9N_33,GPLL1_OUTN | A1 | 35 | IO_L9N_T1_DQS_AD7N_35 | - |
...
| B1 | 33 | IO_R9P_33,GPLL1_OUTP | B1 | 35 | IO_L9P_T1_DQS_AD7P_35 | - |
...
| C1 | 33 | IO_R16N_33，GPLL0_OUTN | C1 | 35 | IO_L16N_T2_35 | - |
| C2 | 33 | IO_R16P_33，GPLL0_OUTP | C2 | 35 | IO_L16P_T2_35 | - |
