...
- [DR1系列FPSoC硬件设计指南](#dr1系列fpsoc硬件设计指南)
  - [一.序言](#一序言)
  - [二.文档参考](#二文档参考)
  ...
  - [六.IO设计](#六io设计)
    ...
    - [差分IO设计指导](#差分io设计指导)
      - [LVDS接口设计](#lvds接口设计)
      - [LVPECL接口设计](#lvpecl接口设计)
      - [Emulated LVDS输出设计](#emulated-lvds输出设计)
    - [时钟IO设计](#时钟io设计)
      - [全局时钟输入](#全局时钟输入)
      - [PLL专用管脚](#pll专用管脚)
      - [时钟信号质量要求](#时钟信号质量要求)
    ...
    - [Processor System(PS) IO设计](#processor-systemps-io设计)
      - [PS IO BANK供电配置](#ps-io-bank供电配置)
      - [PS时钟和复位](#ps时钟和复位)
      - [PS接口信号硬件设计规范](#ps接口信号硬件设计规范)
  - [七.DDR3/DDR4硬件设计规范](#七ddr3ddr4硬件设计规范)
    - [DDR3硬件设计](#ddr3硬件设计)
    - [DDR4硬件设计](#ddr4硬件设计)
  - [八.MIPI DPHY\_RX硬件设计规范](#八mipi-dphy_rx硬件设计规范)
  - [九.封装热参数](#九封装热参数)
    - [封装热阻参数](#封装热阻参数)
    - [热设计要点](#热设计要点)
  - [十.PCB设计指导](#十pcb设计指导)
