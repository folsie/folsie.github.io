# PH100 PCIe Block DMA工程分析报告

## 一、工程概况

- **工程名称**: ph100_pcie_bdma_example
- **目标芯片**: PH1A100SFG676
- **顶层模块**: bdma_app
- **源文件数量**: 17个
- **IP核数量**: 6个
...
**PH100 PCIe Block DMA工程**是一个完整的高性能PCIe DMA解决方案，适合需要大规模数据传输的应用。
